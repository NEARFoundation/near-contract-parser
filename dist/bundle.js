(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global =
      ...
      (global.nearContractParser = factory()));
})(this, function () {
  'use strict';
  ...
  function _decode(bytes) {
...

    {
      ...
      if (_b < 0xe0) {
        return [code(0x80, ((_b & 0x1f) << 6) + con(b2))].concat(
          _toConsumableArray$1(_decode(_bs)),
        );
      }
    }
    /**
...

    {
      ...
      if (_b2 < 0xf0) {
        ...
        ].concat(_toConsumableArray$1(_decode(_bs2)));
      }
    }
    /**
     * 4 bytes
...

    {
      ...
      if (_b4 < 0xf8) {
        ...
        ].concat(_toConsumableArray$1(_decode(_bs3)));
      }
    }
    throw new Error('invalid UTF-8 encoding');
  }
    ...
    if (!(typeof module === 'string')) {
      throw new Error(
        'typeof module === "string"' +
          ' error: ' +
          ('Argument module must be of type string, given: ' +
            _typeof(module) || 'unknown'),
      );
    }
  ...
  function callIndirectInstruction(signature, intrs) {
    if (intrs !== null && intrs !== undefined) {
      if (
        !(_typeof(intrs) === 'object' && typeof intrs.length !== 'undefined')
      ) {
        throw new Error(
  ...
  function insert(_ref2, newNode) {
    ...
    if (!(parentPath != null)) {
      throw new Error(
        'parentPath != null' + ' error: ' + 'Can not remove root node',
      );
    }
  ...
  function decode$1(ab, opts) {
        ...
        if (type == constants.types.func) {
          ...
          typeInstructionNodes.push(
            (function () {
              ...
              return withLoc(
                typeInstruction(undefined, signature(params, result)),
                endLoc,
                _startLoc,
              );
            })(),
    ...
    function parseImportSection(numberOfImports) {
      ...
      for (var i = 0; i < numberOfImports; i++) {
        ...
        if (descrType === 'func') {
          ...
          importDescr = funcImportDescr(
            id,
            signature(signature$1.params, signature$1.result),
          );
        ...
        imports.push(
          (function () {
            var endLoc = getPosition();
            return withLoc(
              moduleImport(moduleName.value, name.value, importDescr),
              endLoc,
              _startLoc2,
            );
          })(),
    ...
    function parseInstructionBlock(code) {
      while (true) {
        ...
        if (typeof instruction$1.object === 'string') {
          dump(
            [instructionByte],
            ''.concat(instruction$1.object, '.').concat(instruction$1.name),
          );
        } else {
        ...
        if (instruction$1.name === 'loop') {
          ...
          var loopNode = (function () {
            var endLoc = getPosition();
            return withLoc(
              loopInstruction(label, blocktype, instr),
              endLoc,
              _startLoc7,
            );
          })();
          ...
          var blockNode = (function () {
            var endLoc = getPosition();
            return withLoc(
              blockInstruction(_label, _instr2, _blocktype2),
              endLoc,
              _startLoc9,
            );
          })();
          ...
          var callNode = (function () {
            var endLoc = getPosition();
            return withLoc(
              callInstruction(indexLiteral(index)),
              endLoc,
              _startLoc6,
            );
          })();
          ...
          var _callNode = callIndirectInstruction(
            signature(signature$1.params, signature$1.result),
            [],
          );
           ...
           */
          if (
            instruction$1.name === 'grow_memory' ||
            instruction$1.name === 'current_memory'
          ) {
            var _indexU = readU32();
        ...
        if (instructionAlreadyCreated === false) {
          if (typeof instruction$1.object === 'string') {
            ...
            var _node4 = (function () {
              var endLoc = getPosition();
              return withLoc(
                instruction(instruction$1.name, args),
                endLoc,
                _startLoc6,
              );
            })();
    ...
    function parseNameSectionLocals() {
      ...
      for (var i = 0; i < numbeOfFunctions; i++) {
        ...
        for (var _i4 = 0; _i4 < numLocals; _i4++) {
          ...
          eatBytes(name.nextIndex);
          localNames.push(
            localNameMetadata(name.value, localIndex, functionIndex),
          );
        }
      }
    ...
    function parseElemSection(numberOfElements) {
      ...
      for (var i = 0; i < numberOfElements; i++) {
        ...
        var elemNode = (function () {
          var endLoc = getPosition();
          return withLoc(
            elem(indexLiteral(tableindex), instr, indexValues),
            endLoc,
            _startLoc12,
          );
        })();
    ...
    function parseDataSection(numberOfElements) {
      ...
      for (var i = 0; i < numberOfElements; i++) {
        ...
        dump([], 'init');
        dataEntries.push(
          data(memIndexLiteral(memoryIndex), instrs[0], byteArray(bytes)),
        );
      }
    ...
    function parseSection(sectionIndex) {
      ...
      switch (sectionId) {
        ...
        case constants.sections.table: {
          ...
          var _metadata2 = sectionMetadata(
            'table',
            startOffset,
            sectionSizeInBytesNode,
            (function () {
        ...
        case constants.sections.import: {
          ...
          var _metadata3 = sectionMetadata(
            'import',
            startOffset,
            sectionSizeInBytesNode,
            (function () {
        ...
        case constants.sections.func: {
          ...
          var _metadata4 = sectionMetadata(
            'func',
            startOffset,
            sectionSizeInBytesNode,
            (function () {
        ...
        case constants.sections.export: {
          ...
          var _metadata5 = sectionMetadata(
            'export',
            startOffset,
            sectionSizeInBytesNode,
            (function () {
        ...
        case constants.sections.code: {
          ...
          var _metadata6 = sectionMetadata(
            'code',
            startOffset,
            sectionSizeInBytesNode,
            (function () {
        ...
        case constants.sections.start: {
          ...
          var _metadata7 = sectionMetadata(
            'start',
            startOffset,
            sectionSizeInBytesNode,
          );
        ...
        case constants.sections.element: {
          ...
          var _metadata8 = sectionMetadata(
            'element',
            startOffset,
            sectionSizeInBytesNode,
            (function () {
        ...
        case constants.sections.global: {
          ...
          var _metadata9 = sectionMetadata(
            'global',
            startOffset,
            sectionSizeInBytesNode,
            (function () {
        ...
        case constants.sections.memory: {
          ...
          var _metadata10 = sectionMetadata(
            'memory',
            startOffset,
            sectionSizeInBytesNode,
            (function () {
              var endLoc = getPosition();
              return withLoc(
                numberLiteralFromRaw(_numberOfElements),
                endLoc,
                _startLoc21,
              );
            })(),
        ...
        case constants.sections.data: {
          ...
          var _metadata11 = sectionMetadata(
            'data',
            startOffset,
            sectionSizeInBytesNode,
          );
          ...
          _metadata11.vectorOfSize = (function () {
            var endLoc = getPosition();
            return withLoc(
              numberLiteralFromRaw(_numberOfElements2),
              endLoc,
              _startLoc22,
            );
          })();
        ...
        case constants.sections.custom: {
          ...
          dump([sectionSizeInBytes], 'section size');
          var _metadata12 = [
            sectionMetadata('custom', startOffset, sectionSizeInBytesNode),
          ];
      ...
      if (moduleExport$1.id != null) {
        moduleFields.push(
          withLoc(
            moduleExport(
              moduleExport$1.name,
              moduleExportDescr(moduleExport$1.type, moduleExport$1.id),
            ),
            moduleExport$1.endLoc,
            moduleExport$1.startLoc,
          ),
        );
      }
    });
    ...
    var module$1 = module(
      ...
      moduleFields,
      moduleMetadata(
        moduleMetadata$1.sections,
        moduleMetadata$1.functionNames,
        moduleMetadata$1.localNames,
        moduleMetadata$1.producers,
      ),
    );
